; 2. Diseñe en ensamblador, una rutina (procedimiento que será llamado con INT),
...
; Segmento SP + 10, OFFSET SP + 8, (FLAGS SP + 6), (CS SP + 4), (IP SP + 2)
INT_HAS_#:
    ...
    MOV AX, [BP+10]        ; Obtener el segmento de la cadena que se encuentra
                          ; en la tercera posición de la pila
                          ; al registro temporal ax
    MOV DS, AX            ; Copiar el segmento a ax
    MOV SI, [BP+8]        ; Copiar el offset de la cadena que se encuentra
    ...
    HAS_H_loop:           ; Etiqueta de ciclo
        ...
        JEQ END_LOPP      ; Salta a terminar ciclo si la resta da 0
